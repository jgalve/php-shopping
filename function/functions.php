        ...
        while ($row_pro = mysqli_fetch_array($run_pro)) {
          ...
          echo "
            <div class='col-md-4 col-sm-6 col-prods'>
              ...
              <h3>$pro_title</h3>
              <span class='price'> PRICE: Php $pro_price </span>
              <a href='details.php?pro_id=$pro_id' class='pull-right'>DETAILS</a>
              <div class='clearfix'></div>
              <a href='index.php?add_cart=$pro_id' class='btn btn-primary center-block' name='add_cart'>ADD TO CART</a>
            </div>
          ";
...
function getCatPro() {
  ...
  if (isset($_GET['cat'])) {
    ...
    if ($count_cats == 0) {
      echo "<h4>There is no products in this category</h4>";
      exit();
    }
...
function getBrandPro() {
  ...
  if (isset($_GET['brand'])) {
    ...
    if ($count_brands == 0) {
      echo "<h4>There is no products in this brand.</h4>";
      exit();
    }
